...
<head>
    ...
    <title>Create New Book - MehdiSarf Admin Page</title>
...
<div align="center">
    ...
    <form method="post" action="create_book" id="bookForm" enctype="multipart/form-data">
        ...
        <table class="tablesinform">
            ...
            <tr>
                ...
                <td align="left"><input type="text" size="30" name="title" id="title"></td>
                <!-- id ham moshakhas mikonam ke betunam ba js bashun kar konam. -->
            </tr>

            <tr>
                <td align="right">Author:</td>
                <td align="left"><input type="text" size="30" name="author" id="author"></td>
            </tr>

            <tr>
                <td align="right">ISBN:</td>
                <td align="left"><input type="text" size="30" name="isbn" id="isbn"></td>
            </tr>

            <tr>
                <td align="right">Publish Date:</td>
                <td align="left"><input type="text" size="30" name="publishDate" id="publishDate"></td>
            </tr>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <img src="" id="thumbnail" alt="Preview" style="width: 20%; margin-top: 10px">
                </td>
            </tr>

            <tr>
                <td align="right">Price:</td>
                <td align="left"><input type="text" size="30" name="price" id="price"></td>
            </tr>
